...
class CalendarEventsControllerTest < ActionController::TestCase
  ...
  test "should create calendar_event" do
    assert_difference('CalendarEvent.count') do
      post :create, calendar_event: { end_time: @calendar_event.end_time, name: @calendar_event.name, start_time: @calendar_event.start_time }
    end
  ...
  test "should update calendar_event" do
    patch :update, id: @calendar_event, calendar_event: { end_time: @calendar_event.end_time, name: @calendar_event.name, start_time: @calendar_event.start_time }
    assert_redirected_to calendar_event_path(assigns(:calendar_event))
  end
